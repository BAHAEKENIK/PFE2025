...
namespace App\Http\Controllers\Provider; // Adapter le namespace pour Client/Provider
...
class DashboardController extends Controller // Adapter le nom de classe
{
    ...
    public function index()
    {
        ...
        return view('provider.dashboard'); // Adapter le nom de la vue pour Client/Provider
    }
}
