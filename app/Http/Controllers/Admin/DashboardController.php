...
namespace App\Http\Controllers\Admin; // Adapter le namespace pour Client/Provider
...
class DashboardController extends Controller // Adapter le nom de classe
{
    ...
    public function index()
    {
        ...
        return view('admin.dashboard'); // Adapter le nom de la vue pour Client/Provider
    }
}
